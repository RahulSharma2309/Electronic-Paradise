// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AuthServiceTests.cs" company="Electronic-Paradise">
...
namespace AuthService.Core.Test.Business
{
    public class AuthServiceTests
    {
        ...
        private readonly Mock<ILogger<AuthServiceBusiness>> logger;

        public AuthServiceTests()
        {
            this.userRepository = new Mock<IUserRepository>();
            this.passwordHasher = new Mock<IPasswordHasher>();
            this.logger = new Mock<ILogger<AuthServiceBusiness>>();
        }
        ...
        {
            // act
            var actual = new AuthServiceBusiness(
        ...
        public async Task GivenValidData_WhenRegisterAsync_ThenReturnsUser()
        {
            ...
            var authService = new AuthServiceBusiness(
                this.userRepository.Object,
                this.passwordHasher.Object,
                this.logger.Object);
